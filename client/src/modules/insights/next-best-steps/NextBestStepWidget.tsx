...
import { X, Activity, Clock, Zap, ArrowRight } from "lucide-react";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
      ...
      setActions([
        {
          ...
          howTo:
            "Review requirements, outline key points, and write a comprehensive proposal",
          effects: "Increases chances of project approval and funding",
          impact: 90,
          priority: 85,
          complexity: 70,
        },
        {
          ...
          score: 75,
          description:
            "Arrange a meeting with the team to discuss project timeline",
          howTo:
            "Use the team calendar to find a suitable time slot for all members",
          effects: "Improves team coordination and project planning",
          impact: 80,
          priority: 75,
          complexity: 30,
        },
        {
          ...
          score: 65,
          description:
            "Go through the latest client feedback and make necessary adjustments",
          howTo:
            "Analyze feedback points, prioritize changes, and update project deliverables",
          effects: "Enhances client satisfaction and project quality",
          impact: 70,
          priority: 60,
          complexity: 50,
        },
