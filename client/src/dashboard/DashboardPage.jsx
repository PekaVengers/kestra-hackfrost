...
import img from "../assets/images/enfj-protagonist.png";
  ...
  return (
    <Card className="">
      <CardHeader className="flex flex-row items-center space-y-0 pb-2">
        ...
        <CardTitle className="text-sm bold">{title}</CardTitle>
      </CardHeader>
      <CardContent>
...
const TagCard = ({ title, icon: Icon, image, description }) => {
  return (
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center">
        <div>
          <div className="flex items-baseline">
            ...
            <p className="text-4xl font-bold gradient-text head ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
        <ScoreCard title="Profile Score" score={82} icon={UserIcon} />
        <ScoreCard title="Interview Readiness" score={6} icon={UserIcon} />
        <TagCard
          title="Innovator"
          icon={Braces}
          image={img}
          description="Innovators are known for their creative and out-of-the-box thinking, often challenging norms to bring new ideas to life."
        />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="col-span-full ">
          <CardHeader>
            <CardTitle className="bold">Your Learning Progress</CardTitle>
          </CardHeader>
          <CardContent>
